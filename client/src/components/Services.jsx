...
const Services = () => {
  return (
    <div className="services-container bg-[#F5F8FA] py-20">
      {/* Title Section */}
      <div className="services-title text-center mb-36">
      ...
      {/* Services Section */}
      <section className="services-grid grid grid-cols-2 gap-y-40 gap-x-24 px-28">
        {services.map((service, index) => (
          <div 
            key={index} 
            className="service-card relative mt-64 bg-[#F5F8FA] py-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300"

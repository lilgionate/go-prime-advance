  ...
  return (
    <div className="relative bg-[#F5F8FA]">
      <section className="clip-bottom flex justify-between items-start text-[#F5F8FA] p-10"
        style={{
          clipPath: 'ellipse(100% 100% at 50% 0)', // Adjusted to create a curved border at the top
        }}>
        <div className="w-6/12 mt-14">
          ...
          <section className="flex flex-col items-start space-y-4 py-4 mt-36">
            <p className="text-lg text-[#F5F8FA] ml-1">In The News</p>
            <div className="flex justify-start space-x-14">
              <img src={Forbes} alt="Forbes" className="h-9" />
              <img src={Cnn} alt="CNN" className="h-9" />
              <img src={Fox} alt="Fox Business" className="h-9" />
            </div>
          </section>
